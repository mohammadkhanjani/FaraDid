...
namespace ViewVlc215
{
    public class Player : UserControl, IPlayerView
    {
        ...
        public int LostRtspRetryMin
        {
            ...
            get { return lostRtspRetryAlert * lostRtspOnStartTimer / 60000; }
        }
        ...
        private int vlcH;
        public int SrcHeight { get{ return vlcH;} }
        private int vlcW;
        public int SrcWidth { get {return vlcW;} }
        ...
        public bool IsPlaying { get { return vlc1Status == VlcStatus.Playing; } }
