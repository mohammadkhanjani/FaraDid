...
namespace Model
{
    ...
    public class EmailAlert
    {
        ...
        public int OnSignalLostBit
        {
            get
            {
                return onSignalLost ? 1 : 0;
            }
            set
            {
                onSignalLost = value == 1;
            }
        }
        ...
        public int OnSignalRecoverBit
        {
            get
            {
                return onSignalRecover ? 1 : 0;
            }
            set
            {
                onSignalRecover = value == 1;
            }
        }

        public string serverUrl = "gmail.com";
        public int serverPort = 587;
        public string emailFrom = "IdeBartarNovinIranFaraDid@gmail.com";
        public string emailTo = "Mohammadengkhanjanni@gmail.com";
