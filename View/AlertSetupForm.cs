...
namespace View
{
    public partial class AlertSetupForm : Form, IAlertSetupView
    {
        ...
        public bool EmLost { get { return emLostCheckBox.Checked; } set { emLostCheckBox.Checked = value; } }
        public int EmLostMin { get { return Convert.ToInt32(emLostMinTextBox.Text); } set { emLostMinTextBox.Text = value.ToString(); } }
        public bool EmRecover { get { return emRecoverCheckBox.Checked; } set { emRecoverCheckBox.Checked = value; } }
        public string EmTo { get { return emToTextBox.Text; } set { emToTextBox.Text = value; } }
        public string EmFrom { get { return emFromTextBox.Text; } set { emFromTextBox.Text = value; } }
        public string EmSerName { get { return emNameTextBox.Text; } set { emNameTextBox.Text = value; } }
        public int EmSerPort { get { return Convert.ToInt32(emPortTextBox.Text); } set { emPortTextBox.Text = value.ToString(); } }
        public string EmUsername { get { return emUsernameTextBox.Text; } set { emUsernameTextBox.Text = value; } }
        public string EmPassword { get { return emPasswordTextBox.Text; } set { emPasswordTextBox.Text = value; } }
