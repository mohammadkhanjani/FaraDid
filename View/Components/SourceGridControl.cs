...
namespace View.Components
{
    public partial class SourceGridControl : UserControl, ISourceGridView
    {
        ...
        {
            get { return WatchDogTimer.Enabled; }
            set { if (value) WatchDogTimer.Enabled = false; WatchDogTimer.Enabled = value; }
        }

        public string EmLostSignalTitle { get { return EmailOnLostSignalTitle.Text; } }
        public string EmLostSignalSubject { get { return EmailOnLostSignalSubject.Text; } }
        public string EmRestoreSignalTitle { get { return EmailOnRestoreSignalTitle.Text; } }
        public string EmRestoreSignalSubject { get { return EmailOnRestoreSignalSubject.Text; } }
