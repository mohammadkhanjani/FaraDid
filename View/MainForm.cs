...
namespace View
{
    public partial class MainForm : Form, IMainView
    {
        ...
        */
        ...
        {
            get { return hintAddCamera.Visible; }
            set
            {
                if (value)
                {
        ...
        {
            get { return hintDropCamera.Visible; }
            set
            {
                if (value)
                {
