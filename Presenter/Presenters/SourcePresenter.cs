...
namespace Presenter.Presenters
{
    class SourcePresenter : BasePresenterControl<ISourceView>
    {
        ...
        public int Position
        {
            ...
            set
            {
                _position = value; if (_source != null) _source.position = value;
            }
        }
        ...
        public bool IsPlaying
        {
            get
            {
                return _shownPlayer != null && _shownPlayer.IsPlaying;
            }
            set
            {
                if (value) CommandPlay(); else CommandStop();
            }
        }
        ...
        public Camera Source
        {
            ...
            set
            {
                if (value != null) SetSource(value); else ResetSource();
            }
        }
